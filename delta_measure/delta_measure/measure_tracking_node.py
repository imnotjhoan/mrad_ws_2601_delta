...
from nav_msgs.msg import Path          # ← para la nueva suscripción al camino planificado
import numpy as np                     
...
FIELDNAMES = [
    ...
    "cte_m",               # cross-track error (distancia al path)
    "heading_error",   # error de orientación respecto al path
    "",    # índice del waypoint más cercano (debug)
    "",    # distancia al waypoint más cercano (debug)
